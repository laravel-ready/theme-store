    ...
    <div class="card-container">
        ...
        <div class="card">
            ...
            <div class="cover-image"
                style="background-image: url(https://images.unsplash.com/photo-1627384113858-ce93ff568d1f?auto=format&fit=crop&w=1170&q=80)">
            </div>
            ...
            <div class="footer">
                <!-- Meta Item -->
                <div class="meta-item">
                    <svg class="class-svg-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
                ...
                <div class="class-div-8">
                    <svg class="class-svg-9" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
