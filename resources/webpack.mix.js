...
mix.css(`${publicPanelAssetsFolder}/css/app.css`, `${publicPanelAssetsFolder}/css/app.min.css`).then((stats) => {
    ...
    fs.readFile(path.resolve(__dirname, `${publicPanelAssetsFolder}/css/app.min.css`), "utf8", (readError, data) => {
        ...
        const result = data
            .replace(new RegExp(/url\(\/fonts\/nucleo-icons/, "g"), "url(../fonts/nucleo-icons")
